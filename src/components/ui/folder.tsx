...
const Folder: React.FC<FolderProps> = ({ color = '#5227FF', size = 1, items = [], className = '', onClick }) => {
  ...
  const folderBackColor = darkenColor(color, 0.4);
  const paper1 = '#8a8a8a'; // Light grey
  const paper2 = '#5e5e5e'; // Medium grey
  const paper3 = '#383838'; // Dark grey
      ...
      >
        <div
          ...
          style={{ 
            ...
            border: '1px solid rgba(232, 195, 94, 0.3)',
            borderTop: '1px solid rgba(232, 195, 94, 0.7)'
          }}
        >
          <span
            className="absolute z-10 bottom-[98%] -left-[1px] w-[30px] h-[10px] rounded-tl-[5px] rounded-tr-[5px] rounded-bl-0 rounded-br-0"
            style={{ 
              backgroundColor: folderBackColor,
              border: '1px solid rgba(232, 195, 94, 0.3)',
              borderTop: '1px solid rgba(232, 195, 94, 0.7)',
          ...
          <div
            className={`absolute z-30 -inset-[1px] origin-bottom transition-all duration-300 ease-in-out ${
